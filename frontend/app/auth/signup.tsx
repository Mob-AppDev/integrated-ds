    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <TextInput
          ...
          style={[styles.input, { marginBottom: 10 }, usernameError && styles.inputError]}
          autoCapitalize="none"
        ...
        <TextInput
          ...
          style={[styles.input, { marginBottom: 10 }, emailError && styles.inputError]}
        ...
        {/* Sign Up Button */}
        <TouchableOpacity 
          style={[styles.signupButton, { marginTop: 14 }, isLoading && { opacity: 0.7 }]} 
